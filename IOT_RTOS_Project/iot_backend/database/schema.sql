...
-- air_quality: giữ để tương thích (thường = PM2.5 hoặc legacy AQI một cột)
CREATE TABLE IF NOT EXISTS sensor_data (
    ...
    air_quality INT NOT NULL DEFAULT 0 COMMENT 'legacy / proxy (thuong trung pm25 khi tu RTOS)',
